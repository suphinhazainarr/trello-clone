...
export default function PlannerPanel() {
  return (
    <section className="bg-[#0d1117] rounded-2xl shadow-lg p-6 w-[400px] min-w-[320px] max-w-[480px] flex flex-col gap-4">
      <h2 className="text-2xl font-bold text-white mb-1">Planner</h2>
